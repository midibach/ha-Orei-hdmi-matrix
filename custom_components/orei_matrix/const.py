...
DEFAULT_TIMEOUT: Final = 15  # Increased for slow status responses
DEFAULT_SCAN_INTERVAL: Final = 10  # Increased to give device time to respond
MIN_SCAN_INTERVAL: Final = 5  # Minimum 5 seconds to avoid overwhelming device
MAX_SCAN_INTERVAL: Final = 300
COMMAND_DELAY: Final = 0.1  # 100ms between commands (increased)
COMMAND_RETRY_DELAY: Final = 0.5  # 500ms before retry
MAX_RETRIES: Final = 2

# Status response settings
STATUS_READ_TIMEOUT: Final = 10  # Seconds to wait for full status response

# Keep-alive / Heartbeat settings
HEARTBEAT_INTERVAL: Final = 30  # Send heartbeat every 30 seconds
HEARTBEAT_TIMEOUT: Final = 5  # Timeout for heartbeat response

# Reconnection settings (exponential backoff)
RECONNECT_MIN_DELAY: Final = 2  # Start with 2 seconds
RECONNECT_MAX_DELAY: Final = 60  # Cap at 60 seconds
RECONNECT_MULTIPLIER: Final = 2  # Double delay each attempt
